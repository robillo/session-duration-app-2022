...
class ReadingAdsPageFragment : BaseFragment() {
    ...
    override fun inject() { AndroidSupportInjection.inject(this) }
    ...
    private fun loadUnifiedAd(unifiedNativeAd: NativeAd) {
        ...
        unifiedNativeAd.icon?.uri?.let {
            unifiedAdViewHolder.installAppIconIv.visibility = View.VISIBLE
            ...
            unifiedAdViewHolder.installAppIconIv.visibility = View.GONE
        }
